...
export default function Dashboard() {
  ...
  // null = still loading, false = no contacts, true = has contacts
  const [hasEmergencyContacts, setHasEmergencyContacts] = useState(null);
    ...
    >
        ...
        >
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
              ...
              <Box>
                <Typography variant="body2" sx={{ opacity: 0.9, mb: 0.5 }}>Welcome back,</Typography>
                <Typography variant="h5" sx={{ fontWeight: 700 }}>{user?.displayName || 'Rider'}</Typography>
        ...
        <Box sx={{ p: 2, flex: 1 }}>
          ...
          {hasEmergencyContacts === false && (
            ...
            >
              ...
              >
                <Warning sx={{ fontSize: 26, color: '#ea580c' }} />
              </Box>
              <Box sx={{ flex: 1 }}>
                <Typography variant="body1" sx={{ fontWeight: 700, color: '#9a3412', mb: 0.25 }}>
                  Set Up Emergency Contacts
                </Typography>
                <Typography variant="body2" sx={{ color: '#c2410c', fontSize: '0.82rem', lineHeight: 1.4 }}>
                  We recommend adding contacts before your first ride. Tap here to set them up.
                </Typography>
              </Box>
              <ArrowForward sx={{ color: '#ea580c', fontSize: 20, flexShrink: 0 }} />
            </Box>
          )}
      ...
      <Dialog open={showVerificationDialog} onClose={() => setShowVerificationDialog(false)} PaperProps={{ sx: { borderRadius: 4, px: 2, py: 1, maxWidth: '400px' } }}>
        <DialogTitle sx={{ textAlign: 'center', pt: 3 }}>
          ...
          <Typography variant="h6" sx={{ fontWeight: 700, color: '#1e293b' }}>Organizer Verification Required</Typography>
        </DialogTitle>
        <DialogContent sx={{ textAlign: 'center', pb: 2 }}>
          <Typography variant="body1" sx={{ color: '#64748b', mb: 1 }}>You need to be a verified organizer to create rides.</Typography>
          <Typography variant="body2" sx={{ color: '#94a3b8' }}>Get verified to organize group rides and build your community!</Typography>
        </DialogContent>
        <DialogActions sx={{ justifyContent: 'center', pb: 3, gap: 2 }}>
          <Button onClick={() => setShowVerificationDialog(false)} sx={{ color: '#64748b', textTransform: 'none', fontWeight: 600 }}>Cancel</Button>
          <Button variant="contained" onClick={() => { setShowVerificationDialog(false); navigate('/become-organizer'); }} sx={{ bgcolor: '#7c3aed', px: 3, py: 1.5, textTransform: 'none', fontWeight: 600, '&:hover': { bgcolor: '#6d28d9' } }}>
